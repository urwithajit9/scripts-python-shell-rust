...
#port 8888 is used to run redis 
# CELERY name space is passed in celery.py ->>> app.config_from_object("django.conf:settings", namespace="CELERY")
CELERY_BROKER_URL = "redis://localhost:8888"
CELERY_RESULT_BACKEND = "redis://localhost:8888"

# These URLs could also point to different servers and services.
# For example, you could use RabbitMQ as your message broker and Redis as your results back end:
